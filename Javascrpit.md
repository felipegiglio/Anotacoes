...
### Manipulando Elementos cores
    ...
    <body>
        ...
        <button type="button" onclick="modifica('red')">Vermelho</button>
        <button onclick="modifica('green')">Verde</button>
        <button onclick="modifica('blue')">Azul</button>
        <hr>
        <div id="quadrado" style="border: solid 2px black; width:100px; height:100px"></div>

        <script>
        function modifica(cordefundo){
...
### Manipulando elementos com altura
    <!DOCTYPE html>
    <html lang="en">
    <head>
        <meta charset="UTF-8">
    ...
    <body>
        ...
        <h3>Manipulando estilos</h3>
        <button type="button" onclick="modifica('red')">Vermelho</button>
        <button onclick="modifica('green','500px')">Verde</button>
        <button onclick="modifica('blue','600px')">Azul</button>
        <hr>
        <div id="quadrado" style="border: solid 2px black; width:100px; height:100px"></div>

        <script>
        function modifica(cordefundo, a, l){
            document.getElementById('quadrado').style.background = cordefundo;
...
### Manipulando elementos com classes
    <!DOCTYPE html>
    <html lang="en">
    <head>
        <meta charset="UTF-8">
    ...
    <body>
    <div id="mensagem" class="estilo1">Modificando</div>
    <hr>
    <button onclick="modifica()">Aplicar as classes</button>
    </body>
    </html>
